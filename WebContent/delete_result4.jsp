...
<body>
	<div class="container">
		<%
			...
			int id_result = Integer.parseInt(request.getParameter("id_result"));
			try {
				...
				PreparedStatement ps = con
						.prepareStatement("delete from results where id_user=" + id + " and id_result=" + id_result);
		...
		<form action="display_results4.jsp" method="post">
			...
			<div class="alert alert-info" role="alert">Le résultat a bien
				été supprimé</div>
