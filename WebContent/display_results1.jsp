...
<body>
	...
	<div class="container text-center">
		<h2 id="haut">Historique des résultats pour ECS – EAE – UGA –
			DECT</h2>
		<br>
		...
		<%
			...
			String sql = "select * from results where system='ECS – EAE – UGA – DECT' and id_user=" + id;
			try {
		...
		<table class="table table-bordered table-responsive-sm">
			<thead class="thead-light text-center">
				<tr>
					...
					<th scope="col">T veille</th>
					<th scope="col">T alarme</th>
			...
			<tbody>
				<tr class="text-center">
					<th scope="row"><%=rs.getInt("id_result")%></th>
					<td><%=rs.getString("i_veille")%></td>
					<td><%=rs.getString("i_alarme")%></td>
					<td><%=rs.getString("t_veille")%></td>
					<td><%=rs.getString("t_alarme")%></td>
					<td><%=rs.getString("result")%></td>
					<td>
						<form action="delete_result1.jsp" method="post">
		...
		<div class="text-center">
			<a href="delete_all_results1_confirmation.jsp"><button
