...
<body>
	...
	<div class="container">
		<h2 id="haut">Historique des résultats pour SMSI avec délestage</h2>
		<br>
		...
		<%
			...
			String sql = "select id_result, system, i_veille, i_alarme, i_delestage, t_delestage, result from results where system='SMSI avec delestage' and id_user="
					+ id;
			try {
		...
		<table class="table table-bordered table-responsive-sm">
			<thead class="thead-light text-center">
				<tr>
					...
					<th scope="col">I alarme</th>
					<th scope="col">I délestage</th>
					<th scope="col">T délestage</th>
			...
			<tbody>
				<tr class="text-center">
					...
					<td><%=rs.getString("i_alarme")%></td>
					<td><%=rs.getString("i_delestage")%></td>
					<td><%=rs.getString("t_delestage")%></td>
					<td><%=rs.getString("result")%></td>
					<td>
						<form action="delete_result3.jsp" method="post">
		...
		<div class="text-center">
			<a href="results.jsp"><button type="button"
					class="btn btn-outline-dark">Retour</button></a><br> <br>
		</div>

		<div class="text-center">
			<a href="#haut"><button type="button"
					class="btn btn-outline-dark">Haut de la page</button></a><br> <br>
		</div>

		<div class="text-center">
			<a href="delete_all_results3_confirmation.jsp"><button
					type="button" class="btn btn-outline-danger">Tout
					supprimer</button></a><br> <br>
		</div>
	</div>
	<%
		} catch (Exception e) {
