...
<body>
	...
	<div class="container">
		<h2 id="haut">Historique des résultats pour SMSI sans délestage
			- AES</h2>
		<br>
		...
		<%
			...
			String sql = "select id_result, system, i_veille, i_alarme, result from results where system='SMSI sans delestage - AES' and id_user="
					+ id;
			try {
		...
		<table class="table table-bordered table-responsive-sm">
			...
			<tbody>
				<tr class="text-center">
					...
					<td>
						<form action="delete_result2.jsp" method="post">
		...
		<div class="text-center">
			<a href="delete_all_results2_confirmation.jsp"><button
